...
function setup() {
	...
	tankB_outerBar = g.rectangle(108, 16, "#3a312e"),
		       tankB_innerBar = g.rectangle(108, 16, "#f26946");

	healthBar_tankB = g.group(tankB_outerBar, tankB_innerBar);
	healthBar_tankB.inner = tankB_innerBar;
	// this is for tankA
	tankA_outerBar = g.rectangle(108, 16, "#3a312e"),
		       tankA_innerBar = g.rectangle(108, 16, "#4eaa4e");
...
function reset() {
	...
	healthBar_tankA.inner.width = 108;
	healthBar_tankB.inner.width = 108;
