	...
	g.shoot(tank,tank.rotation - Math.PI/2,0,-7.5*tank.height,g.stage,7,fire_bullets,
		function() {
		    ...
		    */
		    ...
		    fire_bullet = g.circle(15,"#c36bc3");
		    return fire_bullet;
		});
...
function createWall() {
    ...
    console.log("g.stage.width is " + g.stage.width + " g.stage.height is" + g.stage.height);
